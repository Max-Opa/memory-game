...
const opaImage = document.getElementById('opa-image');
const maxImage = document.getElementById('max-image');
...
function highlightCurrentPlayer() {
	if (currentPlayer === 'Opa') {
		 opaImage.classList.add('active');
		 maxImage.classList.remove('active');
	} else {
		 maxImage.classList.add('active');
		 opaImage.classList.remove('active');
	}
}
